...
def upgrade():
    ...
    op.create_table('donors',
                    ...
                    sa.Column('donor_name', sa.String(
                        length=256), nullable=False),
                    sa.Column('donor_email', sa.String(
    ...
    op.create_table('donor_item',
                    ...
                    sa.ForeignKeyConstraint(
                        ['donor_id'], ['donors.donor_id'], ondelete='CASCADE'),
                    sa.ForeignKeyConstraint(
    ...
    op.create_table('transactions',
                    ...
                    sa.Column('paypal_transaction_id', sa.String(
                    ...
                    sa.Column('donor_email', sa.String(
                        length=256), nullable=True),
                    sa.ForeignKeyConstraint(
                        ['donor_id'], ['donors.donor_id'], ondelete='SET NULL'),
                    sa.ForeignKeyConstraint(
                        ['item_id'], ['items.id'], ondelete='SET NULL'),
